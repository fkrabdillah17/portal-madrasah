...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Tambah Data Kesiswaan</h1>
    </div>
    @if (session('status'))
    ...
    <div class="row">
        ...
        <div class="card shadow col-8 mb-4 mx-auto">
            <div class="card-header py-3 text-center">
                <h6 class="m-0 font-weight-bold text-primary">Form Tambah Data Kesiswaan</h6>
            </div>
            <div class="card-body">
                <form method="post" action="{{ route('kesiswaan.store') }}" enctype="multipart/form-data">
                    @csrf
    ...
    <div class="modal fade" id="staticBackdrop" data-backdrop="static" data-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="post" action="{{ route('kesiswaan.categories.store') }}" enctype="multipart/form-data">
                    @csrf
